<?php
namespace Module\CliFoundation\Parser\GetOpt;
...
class OptionDefinition
{
     ...
     * @return \StdClass
     */
    function newInstance($string, $descr = null)
    {
        if (is_int($string)) {
            $string = $descr;
            $descr = null;
     ...
     *
     */
    protected function newUndefined($name)
    {
        if (strlen($name) == 1)
     ...
     *
     * @return string The fixed name with a leading dash or dashes.
     *
     */
